...
const productos = [
    // componentes 
    {id: "prod-01", producto: "pc gamer - alta gama", precio: 3000, cantidad: 0, img: "./img/pcAlta.png"},
    {id: "prod-02", producto: "pc gamer - gama media", precio: 2000, cantidad: 0, img: "./img/pcMedia.png"},
    {id: "prod-03", producto: "pc gamer - gama baja", precio: 1300, cantidad: 0, img: "./img/pcBaja.png"},

    {id: "prod-04", producto: "procesador intel i9", precio: 750, cantidad: 0, img: "./img/intel-i9.png"},
    {id: "prod-05", producto: "procesador ryzen 7", precio: 500, cantidad: 0, img: "./img/ryzen-7.webp"},
    {id: "prod-06", producto: "procesador ryzen 5", precio: 350, cantidad: 0, img: "./img/ryzen-5.webp"},

    {id: "prod-07", producto: "memoria ram 32gb (2x16)", precio: 350, cantidad: 0, img: "./img/ram32.png"},
    {id: "prod-08", producto: "memoria ram 16gb (2x8)", precio: 200, cantidad: 0, img: "./img/ram16.png"},

    {id: "prod-09", producto: "placa video radeon 7900", precio: 1500, cantidad: 0, img: "./img/radeon7900.png"},
    {id: "prod-10", producto: "placa video rtx 3090", precio: 1000, cantidad: 0, img: "./img/rtx3090.png"},
    {id: "prod-11", producto: "placa video rtx 2080 ti", precio: 750, cantidad: 0, img: "./img/rtx2080.png"},

    {id: "prod-12", producto: "fuente - 1050w", precio: 550, cantidad: 0, img: "./img/fuente.png"},

    {id: "prod-13", producto: "motherboard amd", precio: 400, cantidad: 0, img: "./img/motherAmd.png"},
    {id: "prod-14", producto: "motherboard intel", precio: 400, cantidad: 0, img: "./img/motherIntel.png"},

    {id: "prod-15", producto: "disco sólido - 240gb", precio: 200, cantidad: 0, img: "./img/disco.png"},


    // periféricos
    {id: "prod-16", producto: "silla gamer", precio: 300, cantidad: 0, img: "./img/silla.png"},

    {id: "prod-17", producto: "monitor asus 27' 240hz", precio: 1000, cantidad: 0, img: "./img/asus.png"},
    {id: "prod-18", producto: "monitor samsung 24' 60hz", precio: 250, cantidad: 0, img: "./img/samsung.png"},

    {id: "prod-19", producto: "mouse razer cobra", precio: 150, cantidad: 0, img: "./img/razer.png"},
    {id: "prod-20", producto: "mouse logitech g305", precio: 100, cantidad: 0, img: "./img/logitech.png"},

    {id: "prod-21", producto: "teclado redragon", precio: 250, cantidad: 0, img: "./img/redragon.png"},
    {id: "prod-22", producto: "teclado hyperx", precio: 220, cantidad: 0, img: "./img/hyperx.png"},

    {id: "prod-23", producto: "auriculares cloud flight", precio: 250, cantidad: 0, img: "./img/cloudFlight.png"},
    {id: "prod-24", producto: "auriculares zeus 2", precio: 150, cantidad: 0, img: "./img/zeus2.png"},
];
const carrito = [];
    ...
    for (const producto of productosMostrados) {
        ...
        productoHTML.innerHTML = `
            ...
            <div class="contentBox">
                ...
                <button id="${producto.id}" class="buy">agregar al carrito</button>
            </div>
        `;
...
// MOSTRAR TODAS LAS CARDS AL INICIO, ORDENARLAS
